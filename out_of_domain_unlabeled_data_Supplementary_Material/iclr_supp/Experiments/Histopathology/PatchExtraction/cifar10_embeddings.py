...
def main(data_path, output_path, args):
    ...
    dataset = datasets.CIFAR10(root=dataroot, train=not args.test, download=True, transform=eval_transforms)
    ...
    data_path = os.path.join(output_path, "cifar10_{}_embeddings.pkl".format("train" if not args.test else "test"))
