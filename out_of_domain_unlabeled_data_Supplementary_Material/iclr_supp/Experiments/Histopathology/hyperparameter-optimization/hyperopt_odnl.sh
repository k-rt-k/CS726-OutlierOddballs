CUDA_VISIBLE_DEVICES=0 python3 hyperparameter_optimization_odnl.py --train /users/ug21/atharvatambat/AML-project/CS726-OutlierOddballs/out_of_domain_unlabeled_data_Supplementary_Material/iclr_supp/Experiments/Histopathology/embeddings/cifar100_train_embeddings.pkl \
